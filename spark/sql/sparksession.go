...
type SparkSession interface {
	...
	ExecQuery(ctx context.Context, query string) (output []map[string]interface{}, err error)
	ExecQueryToMapString(ctx context.Context, query string) (output []map[string]string, err error)
	ExecQueryBatchProcessingForString(ctx context.Context, query string, batchSize int, function ...func(input []map[string]string) error) (err error)
	ExecQueryBatchProcessingForInterface(ctx context.Context, query string, batchSize int, function ...func(input []map[string]interface{}) error) (err error)
}
...
func (s *sparkSessionImpl) ExecQuery(ctx context.Context, query string) (output []map[string]interface{}, err error) {
...
func (s *sparkSessionImpl) ExecQueryToMapString(ctx context.Context, query string) (output []map[string]string, err error) {
...
func (s *sparkSessionImpl) dFCollectBatchProcessingForString(ctx context.Context, df DataFrame, batchSize int, function ...func(input []map[string]string) error) (err error) {
	defer func() {
		df = nil
	}()
...
func (s *sparkSessionImpl) ExecQueryBatchProcessingForString(ctx context.Context, query string, batchSize int, function ...func(input []map[string]string) error) (err error) {
	...
	return s.dFCollectBatchProcessingForString(ctx, frame, batchSize, function...)
}

func (s *sparkSessionImpl) dFCollectBatchProcessingForInterface(ctx context.Context, df DataFrame, batchSize int, function ...func(input []map[string]interface{}) error) (err error) {
	defer func() {
		df = nil
	}()
	var collect []types.Row
...
func (s *sparkSessionImpl) ExecQueryBatchProcessingForInterface(ctx context.Context, query string, batchSize int, function ...func(input []map[string]interface{}) error) (err error) {
	...
	return s.dFCollectBatchProcessingForInterface(ctx, frame, batchSize, function...)
}
